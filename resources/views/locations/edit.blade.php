...
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-1">Edit Delivery Address</h2>
            <p class="text-muted mb-0">Update your delivery location information</p>
        </div>
                    ...
                    <form method="POST" action="{{ route('locations.update', $location) }}">
                        ...
                        @else
                            <div class="alert alert-info mb-4">
                                <i class="bi bi-info-circle"></i> This is your primary address. To change it, set another address as primary.
                            </div>
                        @endif
