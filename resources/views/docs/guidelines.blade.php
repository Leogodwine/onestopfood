    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
                <div>
                    <h1 class="h2 fw-bold mb-1"><i class="bi bi-journal-text text-success"></i> System Guidelines</h1>
                    <p class="text-muted mb-0">Platform policies, standards &amp; compliance</p>
                </div>
                <div class="d-flex gap-2">
                    <a href="{{ route('docs.user-manual') }}" class="btn btn-outline-success btn-sm">
            ...
            <div class="alert alert-warning border-0 shadow-sm">
                ...
                <strong>Important:</strong> All chefs and travelers must read and accept these guidelines during verification.
            </div>

            <div class="card border-0 shadow-sm">
                <div class="card-body p-4 p-md-5 doc-content">
                    @include('docs.partials.guidelines-content')
                </div>
            </div>
            ...
            <p class="text-center text-muted small mt-4 mb-0">
                ...
                &nbsp;·&nbsp;
                <a href="mailto:support@onestopfood.co.tz">support@onestopfood.co.tz</a>
            </p>
        </div>
    </div>
</div>
...
.doc-content blockquote { border-left: 4px solid #ffc107; padding: .75rem 1rem; background: #fff8e1; margin: 1rem 0; border-radius: 0 8px 8px 0; }
